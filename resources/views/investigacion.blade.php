    ...
    <div class="inv-contenedor">
                ...
                <div class="inv-sec1">
                        ...
                        <div class="inv-gestor">
                                ...
                                <img src="  {{('images/endnote.png')}}" style="padding-top:60px;" alt="">
                         </div>
                            <div class="inv-gestor">
                            ...
                            <div class="inv-gestor">
                                    ...
                                    <img src="{{('images/mendeley.png')}}"  alt="" style="margin-top:50px;">
                                </div>
                                <div class="inv-gestor">
                                ...
                                <div class="inv-gestor">
                                        ...
                                        <img src=" {{('images/zotero.png')}} "  alt="" style="margin-top:30px;" >
                                    </div>
                                    <div class="inv-gestor">
                ...
                <div class="inv-sec3">
                        ...
                        <div class="inv-sec33">
                            <div class="inv-estilos">
                                    ...
                                    <img src=" {{('images/apaimagen.gif')}} " style="margin-left:10px; float:left;margin-right:15px;" alt="">
