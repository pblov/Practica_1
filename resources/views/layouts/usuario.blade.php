...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>
	...
	<link rel="stylesheet" type="text/css" href="{{asset('css/texteffect.css')}}">
...
<body>
	...
	<header class="general-head-top">
		<div class="general-head-top-logo">
			...
			<a href="/public/inicio"><img src="{{asset('images/logo.png')}}" height="50" width="auto"></a>
		...
		<div class="general-head-top-login"><a href="/public/inicio"><button>Cerrar Sesión</button></a></div>
	</header>
	...
	<div class="general-sidebar">
		<div class="general-nav">
			<ul>
			<li>
				<a href="/public/usuario/inicio" style="text-decoration: none; color: white;"><i class="fa fa-home fa-1x centrartext"></i><p>Inicio</p></a>
				
			</li>
			<li>
				<a href="/servicios" style="text-decoration: none; color: white;"><i class="fas fa-tools fa-1x centrartext"></i><p>Servicios</p></a>
				
			</li>
			<li>
				<a href="/public/usuario/bibliotecas" style="text-decoration: none; color: white;"><i class="fas fa-phone fa-1x centrartext" ></i><p>Bibliotecas</p></a>
				
			</li>
			<li>
				<a href="/public/usuario/reglamento" style="text-decoration: none; color: white;"><i class="fas fa-gavel centrartext" ></i><p>Nosotros</p></a>
				
			</li>
			<li>
				<a href="/public/usuario/investigacion" style="text-decoration: none; color: white;"><i class="fas fa-user-secret centrartext"></i><p>Investigación</p>	</a>
				
			</li>
			<li>
				<a href="/public/usuario/user" style="text-decoration: none; color: white;"><i class="fas fa-user-secret centrartext"></i><p>Reservas</p></a>
