	 ...
	 <div class="nov-header"> </div>
	       <div class="no-container">
            ...
            <div class="no-sec1">
                ...
                <div class="no-cartas">
                        <img src="{{('images/nov/nov2.jpg')}}" alt="">
                        <p> Agronomía Costarricense v.41: nº2(2018:.jul./dic.)</p>
                </div>
               <div class="no-cartas">
                            <img src="{{('images/nov/nov3.jpg')}}" alt="">
                            <p> AITIM nº315(2018:sep./oct.)</p>
                </div>
                <div class="no-cartas">
                        <img src="{{('images/nov/nov4.jpg')}}" alt="">
                        <p> Ambientico nº261(2017:ene./mar.)</p>
                </div>
                <div class="no-cartas">
                        <img src="{{('images/nov/nov5.jpg')}}" alt="">
                ...
                <div class="no-cartas">
                        <img src="{{('images/nov/nov6.jpg')}}" alt="">
                        <p> Area nº22(2016:oct.)</p>
                </div>
                <div class="no-cartas">
                        <img src="{{('images/nov/nov7.jpg')}}" alt="">
                        <p> ARQ n°98(2018:abr.)</p>
                </div>
                <div class="no-cartas">
                        <img src="{{('images/nov/nov8.jpg')}}" alt="">
                        <p> Arteoficio nº12(2016:primavera)</p>
                </div>
                <div class="no-cartas">
                        <img src="{{('images/nov/nov9.jpg')}}" alt="">
                        <p> Asora nº138(2018:jul./ago.)</p>
                </div>
                <div class="no-cartas">
                        <img src="{{('images/nov/nov10.jpg')}}" alt="">
                        <p> Asian Journal of Engineeringnº6(2017:Oct.)</p>
                </div>
                <div class="no-cartas">
                        <img src="{{('images/nov/nov11.jpg')}}" alt="">
                        <p> Boletín Estadístico nº138(2012)

                            </p>
                </div>
                <div class="no-cartas">
                        <img src="{{('images/nov/nov12.jpg')}}" alt="">
                        <p> Building and Environment (2013:Feb.)</p>
                </div>
                <div class="no-cartas">
                        <img src="{{('images/nov/nov13.jpg')}}" alt="">
                        <p> Bit nº121(2018:jul./ago.)</p>
                </div>
                <div class="no-cartas">
                        <img src="{{('images/nov/nov14.jpg')}}" alt="">
                        <p> Ciencias Sociales, econ., ped. n°3(2013:feb./nov.)</p>
                </div>
                <div class="no-cartas">
                        <img src="{{('images/nov/nov15.jpg')}}" alt="">
