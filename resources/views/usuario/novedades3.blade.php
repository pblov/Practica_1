	...
	@section('estilo')
	 ...
	 <div class="nov-header"> </div>
	      ...
	      <div class="no-container">
            ...
            <div class="no-sec1">
                <div class="no-cartas">
                    <img src="{!!asset('images/nov3/nov1.jpg')!!}" alt="">
                    <p> Arquitecturas del Sur (2016:jun.)</p>
                </div>
                <div class="no-cartas">
                       <img src="{!!asset('images/nov3/nov2.jpg')!!}" alt="">
                        <p > Boletín urbano (2015:nov.)

                            </p>
                </div>
               <div class="no-cartas">
                          <img src="{!!asset('images/nov3/nov3.jpg')!!}" alt="">
                            <p > Cientochenta (2015:ago.)</p>
                </div>
                <div class="no-cartas">
                       <img src="{!!asset('images/nov3/nov4.jpg')!!}" alt="">
                        <p >Concepción Construye (2016:abr.)</p>
                </div>
                <div class="no-cartas">
                      <img src="{!!asset('images/nov3/nov5.jpg')!!}" alt="">
                        <p> Mensaje (2016:nov.)
                            </p>
                </div>
                <div class="no-cartas">
                       <img src="{!!asset('images/nov3/nov6.jpg')!!}" alt="">
                        <p>National Geographic en español (2016:dic.)</p>
                </div>
                <div class="no-cartas">
                      <img src="{!!asset('images/nov3/nov7.jpg')!!}" alt="">
                        <p> Patrimonio Cultural (2015:verano)</p>
                </div>
                <div class="no-cartas">
                       <img src="{!!asset('images/nov3/nov8.jpg')!!}" alt="">
                        <p> 	
                ...
                <div class="no-cartas">
                       <img src="{!!asset('images/nov3/nov15.jpg')!!}" alt="">
