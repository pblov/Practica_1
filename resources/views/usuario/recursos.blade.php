@extends('layouts.usuario')
	...
	<div class="re-head"></div>
		...
		<div class="re-secciones">
			...
			<div class="re-seccion revistas">
				<img src="{{asset('images/macrofacultad.jpg')}}" width="250px" height="300px" alt="">
			
				<h4>Macrofacultad</h4><p><br>ISSN:-<br>ISSNe:-</p>
			</div>
			<div class="re-seccion revistas">
				<img src="{{asset('images/maderas.jpg')}}" width="250px" height="300px" alt="">
	
				<h4>Maderas: Ciencia y Tecnología</h4><p><br>ISSN:0717-3644<br>ISSNe:0718-221X</p>
			</div>
			<div class="re-seccion revistas">
				<img src="{{asset('images/sueldo.gif')}}" width="250px" height="300px" alt="">
				<h4>Mercado de Sueldo</h4><p><br>ISSN:0716-775X<br>ISSNe:-</p>
			</div>
			<div class="re-seccion revistas">
				<img src="{{asset('images/proyeccion.png')}}" width="250px" height="300px" alt="">
				<h4>Proyección UBB</h4><p><br>ISSN:-<br>ISSNe:-</p>
			</div>
			<div class="re-seccion revistas">
			

				<img src="{{asset('images/industrial.jpg')}}" width="250px" height="300px" alt="">
				<h4>Ingeniería Industrial</h4><p><br>ISSN:0717-9103<br>ISSNe:0718-8307</p>
			</div>
			<div class="re-seccion revistas">
			

				<img src="{{asset('images/piensa.jpg')}}" width="250px" height="300px" alt="">
				<h4>Piensa en Acción</h4><p><br>ISSN:-<br>ISSNe:-</p>
			</div>
			<div class="re-seccion revistas">
				
				<img src="{{asset('images/pequen.jpg')}}" width="250px" height="300px" alt="">
				<h4>Pequen</h4><p><br>ISSN:0719-112X<br>ISSNe:-</p>
			</div>
			<div class="re-seccion revistas">
				<img src="{{asset('images/tiempo.jpg')}}" width="250px" height="300px" alt="">
				
				<h4>Tiempo y Espacio</h4><p><br>ISSN:0716-9671<br>ISSNe:0719-0867</p>
			</div>
			<div class="re-seccion revistas">
				<img src="{{asset('images/teoria.jpg')}}" width="250px" height="300px" alt="">
				<<h4>Theoría</h4><p><br>ISSN:0717-196X<br>ISSNe:-</p>
			</div>
			<div class="re-seccion revistas">
				<img src="{{asset('images/urbano.jpg')}}" width="250px" height="300px" alt="">
