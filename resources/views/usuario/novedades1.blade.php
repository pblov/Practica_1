...
<div class="nov-header"> </div>
	   <div class="no-container">
            ...
            <div class="no-sec1">
                <div class="no-cartas">
                 <img src="{!!asset('images/nov1/nov1.jpg')!!}" alt="">
                    <p> Acta literaria nº52(2016:1ºsemestre)</p>
                </div>
                <div class="no-cartas">
                      <img src="{!!asset('images/nov1/nov2.jpg')!!}" alt="">
                        <p> Akadémeia v.13:nº2(2015:dic.)</p>
                </div>
               <div class="no-cartas">
                           <img src="{!!asset('images/nov1/nov3.jpg')!!}" alt="">>
                            <p> Alpha nº39(2014:dic.)</p>
                </div>
                <div class="no-cartas">
                   <img src="{!!asset('images/nov1/nov4.jpg')!!}" alt="">
                        <p> Almanaque mundial (2012)</p>
                </div>
                <div class="no-cartas">
                       <img src="{!!asset('images/nov1/nov5.jpg')!!}" alt="">
                        <p> Anales del Instituto de la Patagonia v.43:nº2(2015)

                            </p>
                </div>
                <div class="no-cartas">
                       <img src="{!!asset('images/nov1/nov6.jpg')!!}" alt="">
                        <p> Anales del museo de historia natural de Valparaíso nº28(2015)</p>
                </div>
                <div class="no-cartas">
                      <img src="{!!asset('images/nov1/nov7.jpg')!!}" alt="">
                        <p> Andean geology v.38:nº2(2011:july)</p>
                </div>
                <div class="no-cartas">
                      <img src="{!!asset('images/nov1/nov8.jpg')!!}" alt="">
                        <p> 	
                                Anuario estadístico (Consejo de Rectores) (2011)</p>
                </div>
                <div class="no-cartas">
                       <img src="{!!asset('images/nov1/nov9.jpg')!!}" alt="">
                        <p> Apuntes de teatro nº139(2014)</p>
                </div>
                <div class="no-cartas">
                  <img src="{!!asset('images/nov1/nov10.jpg')!!}" alt="">
                        <p> Arquitecturas del sur v.34:nº49(2016:jun.))</p>
                </div>
                <div class="no-cartas">
                        <img src="{!!asset('images/nov1/nov11.jpg')!!}" alt="">
                        <p> Atenea nº513(2016:1ºsemestre)

                            </p>
                </div>
                <div class="no-cartas">
                        <img src="{!!asset('images/nov1/nov12.jpg')!!}" alt="">
                        <p> Boletín Antártico Chileno v.34:nº1(2015)</p>
                </div>
                <div class="no-cartas">
                        <img src="{!!asset('images/nov1/nov13.jpg')!!}" alt="">
                        <p> Boletín urbano nº32(2015:nov.)</p>
                </div>
                <div class="no-cartas">
                       <img src="{!!asset('images/nov1/nov14.jpg')!!}" alt="">
                        <p> Calpe y abyla nº8(2012:oct.)</p>
                </div>
                <div class="no-cartas">
                      <img src="{!!asset('images/nov1/nov15.jpg')!!}" alt="">
