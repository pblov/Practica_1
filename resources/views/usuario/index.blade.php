	...
	<link rel="stylesheet" type="text/css" href="{{asset('css/inicio-mobile.css')}}">
	<link rel="stylesheet" type="text/css" href="{{asset('css/newbook.css')}}">
	...
	@section('contenedor')
		...
		<div class="secciones">
			...
			<div class="seccion3 relativo sec texto">
				<a href="/public/usuario/novedades">
					<div class="s3image img">
						<h2  class="descripcion"><b>Novedades </b> </h2>
					<p style="font-size:15px;">Novedades de libros/revistas en cada sede de la UBB </p>
					</div>
				</a>
			...
			<div class="seccion5 relativo sec texto">
				<a href="/public/usuario/recursos">
	...
	<!----------------------------------------------------------------------------------------->
			<div class="seccion8 relativo sec texto">
				<a href="/public/usuario/memoristas"><div class="s8image img">
