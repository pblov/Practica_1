@extends('layouts.general')
	...
	@section('estilo')   
	<link rel="stylesheet" href="css/bibliotecas2.css">
	@endsection
	@section('contenedor')
		<!--------------------intro------------------>
        ...
        <div class="bi-seccion2">
            <a href="#biblio1" style="text-decoration: none;">
                    <div class="bi-cartas">
                            ...
                            <img src="{{('images/biblio1.jpg')}}" alt="">
            ...
            <a href="#biblio2" style="text-decoration: none;">
                    <div class="bi-cartas">
                            ...
                            <img src="{{('images/biblio2.jpg')}}" alt="">
            ...
            <a href="#biblio3" style="text-decoration: none;">
                    <div class="bi-cartas">
                            ...
                            <img src="{{('images/biblio3.jpg')}}" alt="">
            ...
            <a href="#biblio4" style="text-decoration: none;">
                    <div class="bi-cartas">
                            ...
                            <img src="{{('images/biblio4.jpg')}}" alt="">
            ...
            <a href="#biblio5" style="text-decoration: none;">
                    <div class="bi-cartas">
                            ...
                            <img src="{{('images/biblio5.jpg')}}" alt="">
